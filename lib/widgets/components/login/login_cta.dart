...
class LoginCTA extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<LoginBloc, LoginState>(
        ...
        return FlatButton(
            onPressed: () => (state.onPage == OnPage.inputEmail)
                ? Navigator.push(context, HomePage.route())
                : {context.read<LoginBloc>().add(const LoginGoBack())}, //TODO Replace homepage with a register page
            child: Text(
              state.onPage == OnPage.inputEmail
