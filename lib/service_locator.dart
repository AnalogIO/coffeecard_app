...
void configureServices() {
  ...
  sl.registerSingleton<CoffeeCardApiClient>(CoffeeCardApiClient(_dio, baseUrl: CoffeeCardApiClient.testUrl)); //TODO load the url from config files

  // Repositories
  sl.registerFactory<AccountRepository>(
      () => AccountRepositoryImpl(sl<CoffeeCardApiClient>(), sl<Logger>(), sl<SecureStorage>()));

  sl.registerSingleton<AuthenticationRepository>(AuthenticationRepository(sl<AccountRepository>()));
